...
<body>
	...
	<div id="join_info">
		<h3>Home Ground 처음이세요? <span>가입하기</span></h3> 
		<form action="register/createUserForm.jsp" method="post">
			<input type="password" name="addid" id="addid" placeholder="아이디" title="아이디" />
			<input type="password" name="addmail" id="addmail" placeholder="이메일 주소" title="이메일 주소" />
			<input type="password" name="addpw" id="addpw" placeholder="비밀번호" title="비밀번호" maxlength="12"/>
